...
uint8_t UART1_TXBuff[USART_ASCII_MIN_DATALEN];
uint8_t UART1_RXBuff[USART_ASCII_MAX_DATALEN];//接收缓冲,最大USART_REC_LEN个字节.
...
//	{
//		TX_ON;
//		uprintf("%c", cyAsciiBuff[i]);
//		if(cyAsciiBuff[i] == 0x0A)
//			break;
//		i++;
//	}
	
	UARTx_SendData(cyAsciiBuff, cyAsciiLen);
//	RX_ON;
    return 0;
}
