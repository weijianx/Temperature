...
#define	RS485CTL_PIN		GPIO_PIN_4
...
#define	USART0_ADDR_DATA	0x40013828
#define	READ_USART0_DATA()	(*(volatile uint32_t *)(uint32_t)(0x40013828))


//USART1 ADDRESS
#define	USART1_ADDR_BASE	0x40004400
#define	USART1_ADDR_DATA	0x40004428
