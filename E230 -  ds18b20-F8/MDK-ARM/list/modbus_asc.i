# 1 "../APP/Src/modbus_asc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 359 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../APP/Src/modbus_asc.c" 2
...
extern uint8_t Cur_Param[(((((((0x00 + 0x02) + 0x01) + 0x01) + 0x02) + 0x02) + 0x02) + 0x02)];
extern uint8_t const User_Default_Param[(((((((0x00 + 0x02) + 0x01) + 0x01) + 0x02) + 0x02) + 0x02) + 0x02)];


uint8_t const SensorSoftVersion[10] = {0x07, 'G', 'D', '1', '.', '0', '.', '0'};
# 48 "../APP/Src/modbus_asc.c"
uint32_t MBASC_GetSlaveAddr(uint8_t *uint8_tMsg)
{
    return(uint8_tMsg[0]);
}
# 65 "../APP/Src/modbus_asc.c"
void MBASC_SendMsg(uint8_t *u8Msg, uint8_t u8MsgLen)
{
    if(0x00 != u8Msg[0])
    {
...
void MBASC_Fun03(void)
{
    ...
    if ((!(((ReadAdrL >= 0x30) && (ReadAdrL <= 0x4F)
        && (ReadAdrL + Register_Num <= (0x4F + 1)))&& (0 != Register_Num)))
        || ((ReadAdrH != UserPara.SlaveAddr) && (ReadAdrH != 0x00)))
    {
        MBASC_SendErr((0x02));
        return;
    }
    ...
    for (uint8_t k = 0; k < Register_Num; ReadAdrL++, k++)
    {
        switch (ReadAdrL)
        {
          ...
          case 0x40:
            Data_Buf = UserPara.Up_Thr;
            break;

          case 0x41:
            Data_Buf = UserPara.Do_Thr;
            break;

          case 0x42:
            Data_Buf = UserPara.Du_Thr;
            break;
...
void MBASC_Fun04(void)
{
 ...
 uint8_t ReadAdr_L;
    ...
    if(!((((ReadAdr_L <= 0x450E)
    && ((ReadAdr_L + Register_Num) <= (0x450E + 2)))
    || ((ReadAdr_L >= 0x4540) && (ReadAdr_L <= 0x4542)
    && ((ReadAdr_L + Register_Num) <= (0x4542 + 2)))
    ||((ReadAdr_L >= 0x4580) && (ReadAdr_L <= 0x458C)
    && ((ReadAdr_L + Register_Num) <= (0x458C + 2))))
...
void MBASC_Fun10()
{
 ...
 SendBuf[SendLen++] = 0x10;
    ...
    Flash_Write_MultiBytes((0x00 + 0x02), &UserPara.SlaveAddr , 1);
    ...
    UserPara.Baudrate = ((uint16_t)UARTx_RXBuff[7+index] << 8) + UARTx_RXBuff[8+index];
                ...
                Flash_Write_MultiBytes(((0x00 + 0x02) + 0x01), &UserPara.Baudrate , 1);
    ...
    upload_persist = ((uint16_t)UARTx_RXBuff[7+index] << 8) + UARTx_RXBuff[8+index];
                ...
                Flash_Write_MultiBytes(((((((0x00 + 0x02) + 0x01) + 0x01) + 0x02) + 0x02) + 0x02), &UserPara.Upload_persist, 1);
                break;
            ...
            case 0x40:
                ...
                Flash_Write_MultiBytes((((0x00 + 0x02) + 0x01) + 0x01), (uint8_t*)&UserPara.Up_Thr, 2);
                break;

            case 0x41:
                UserPara.Do_Thr = ((uint16_t)UARTx_RXBuff[7+index] << 8) + UARTx_RXBuff[8+index];
                Flash_Write_MultiBytes(((((0x00 + 0x02) + 0x01) + 0x01) + 0x02), (uint8_t*)&UserPara.Do_Thr, 2);
                break;

            case 0x42:
                UserPara.Du_Thr = ((uint16_t)UARTx_RXBuff[7+index] << 8) + UARTx_RXBuff[8+index];
                Flash_Write_MultiBytes((((((0x00 + 0x02) + 0x01) + 0x01) + 0x02) + 0x02), (uint8_t*)&UserPara.Du_Thr, 2);
                break;
...
# 483 "../APP/Src/modbus_asc.c"
void MBASC_Fun2B(void)
{
    uint16_t Object_Num = 0, ReadAdr = 0;
    uint8_t CompanyNameLen = 0;
    uint8_t SoftwareVersionLen = 0;

    if(UserPara.SlaveAddr != UARTx_RXBuff[2])
    {
    ...
    for (uint8_t k = 0; k < Object_Num; ReadAdr++, k++)
    {
        ...
        case 0x51E3:
            ...
            else
            {
                ...
                {
                    SendBuf[SendLen++] = SensorSoftVersion[i+1];
                }
            }
            break;
...
void MBASC_Fun41(void)
{
 ...
 SendBuf[SendLen++] = 0x41;
    ...
    if((0x0001 != ReadAdr) || (0 != DataLength) || (UARTx_RXBuff[0] == 0x00))
    {
        return;
    }
    else
...
void MBASC_Function(void)
{
    ...
    if(UartRecvFrameOK == SET)
    {
        ...
        else if((UserPara.SlaveAddr != UARTx_RXBuff[0])&& (0x00 != UARTx_RXBuff[0]))
        {
            return;
        }
 ...
 else if(UserPara.Upload_persist != 0)
 {
   timer_interrupt_enable(((((uint32_t)0x40000000U) + 0x00000000U) + 0x00014400U), ((uint32_t)((uint32_t)0x01U<<(0))));
   timer_enable(((((uint32_t)0x40000000U) + 0x00000000U) + 0x00014400U));
  ...
  if(AutoUpLoad_counter == UserPara.Upload_persist)
  {
   ...
   timer_interrupt_disable(((((uint32_t)0x40000000U) + 0x00000000U) + 0x00014400U), ((uint32_t)((uint32_t)0x01U<<(0))));
   timer_disable(((((uint32_t)0x40000000U) + 0x00000000U) + 0x00014400U));
