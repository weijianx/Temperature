# 1 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_exti.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 359 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_exti.c" 2
# 37 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_exti.c"
...
# 38 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_exti.c" 2
...
void exti_deinit(void)
{
    ...
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000400U) + 0x00U)) = (uint32_t)0x0F940000U;
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000400U) + 0x04U)) = (uint32_t)0x00000000U;
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000400U) + 0x08U)) = (uint32_t)0x00000000U;
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000400U) + 0x0CU)) = (uint32_t)0x00000000U;
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000400U) + 0x10U)) = (uint32_t)0x00000000U;
}
# 72 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_exti.c"
void exti_init(exti_line_enum linex, exti_mode_enum mode, exti_trig_type_enum trig_type)


{

    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000400U) + 0x00U)) &= ~(uint32_t)linex;
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000400U) + 0x04U)) &= ~(uint32_t)linex;
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000400U) + 0x08U)) &= ~(uint32_t)linex;
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000400U) + 0x0CU)) &= ~(uint32_t)linex;
...
# 121 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_exti.c"
void exti_interrupt_enable(exti_line_enum linex)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000400U) + 0x00U)) |= (uint32_t)linex;
}
# 134 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_exti.c"
void exti_event_enable(exti_line_enum linex)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000400U) + 0x04U)) |= (uint32_t)linex;
}
# 147 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_exti.c"
void exti_interrupt_disable(exti_line_enum linex)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000400U) + 0x00U)) &= ~(uint32_t)linex;
}
# 160 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_exti.c"
void exti_event_disable(exti_line_enum linex)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000400U) + 0x04U)) &= ~(uint32_t)linex;
}
# 173 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_exti.c"
FlagStatus exti_flag_get(exti_line_enum linex)
{
    if(RESET != ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000400U) + 0x14U)) & (uint32_t)linex)){
        return SET;
    }else{
        return RESET;
    }
}
# 190 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_exti.c"
void exti_flag_clear(exti_line_enum linex)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000400U) + 0x14U)) = (uint32_t)linex;
}
# 203 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_exti.c"
FlagStatus exti_interrupt_flag_get(exti_line_enum linex)
{
    uint32_t flag_left, flag_right;

    flag_left = (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000400U) + 0x14U)) & (uint32_t)linex;
    flag_right = (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000400U) + 0x00U)) & (uint32_t)linex;
...
# 225 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_exti.c"
void exti_interrupt_flag_clear(exti_line_enum linex)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000400U) + 0x14U)) = (uint32_t)linex;
}
# 238 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_exti.c"
void exti_software_interrupt_enable(exti_line_enum linex)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000400U) + 0x10U)) |= (uint32_t)linex;
}
# 251 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_exti.c"
void exti_software_interrupt_disable(exti_line_enum linex)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00000400U) + 0x10U)) &= ~(uint32_t)linex;
}
