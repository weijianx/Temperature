# 1 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_gpio.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 359 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_gpio.c" 2
# 37 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_gpio.c"
...
# 38 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_gpio.c" 2
# 47 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_gpio.c"
void gpio_deinit(uint32_t gpio_periph)
{
    switch(gpio_periph){
...
# 95 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_gpio.c"
void gpio_mode_set(uint32_t gpio_periph, uint32_t mode, uint32_t pull_up_down, uint32_t pin)
{
    uint16_t i;
    uint32_t ctl, pupd;
...
# 139 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_gpio.c"
void gpio_output_options_set(uint32_t gpio_periph, uint8_t otype, uint32_t speed, uint32_t pin)
{
    uint16_t i;
    uint32_t ospeed;
...
# 175 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_gpio.c"
void gpio_bit_set(uint32_t gpio_periph, uint32_t pin)
{
    (*(volatile uint32_t *)(uint32_t)((gpio_periph) + 0x18U)) = (uint32_t)pin;
}
# 191 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_gpio.c"
void gpio_bit_reset(uint32_t gpio_periph, uint32_t pin)
{
    (*(volatile uint32_t *)(uint32_t)((gpio_periph) + 0x28U)) = (uint32_t)pin;
}
# 210 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_gpio.c"
void gpio_bit_write(uint32_t gpio_periph, uint32_t pin, bit_status bit_value)
{
    if(RESET != bit_value){
        (*(volatile uint32_t *)(uint32_t)((gpio_periph) + 0x18U)) = (uint32_t)pin;
...
# 228 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_gpio.c"
void gpio_port_write(uint32_t gpio_periph, uint16_t data)
{
    (*(volatile uint32_t *)(uint32_t)((gpio_periph) + 0x14U)) = (uint32_t)data;
}
# 244 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_gpio.c"
FlagStatus gpio_input_bit_get(uint32_t gpio_periph, uint32_t pin)
{
...
# 261 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_gpio.c"
uint16_t gpio_input_port_get(uint32_t gpio_periph)
{
    return (uint16_t)(*(volatile uint32_t *)(uint32_t)((gpio_periph) + 0x10U));
}
# 277 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_gpio.c"
FlagStatus gpio_output_bit_get(uint32_t gpio_periph, uint32_t pin)
{
...
# 294 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_gpio.c"
uint16_t gpio_output_port_get(uint32_t gpio_periph)
{
    return (uint16_t)(*(volatile uint32_t *)(uint32_t)((gpio_periph) + 0x14U));
}
# 320 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_gpio.c"
void gpio_af_set(uint32_t gpio_periph, uint32_t alt_func_num, uint32_t pin)
{
    uint16_t i;
    uint32_t afrl, afrh;
...
# 359 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_gpio.c"
void gpio_pin_lock(uint32_t gpio_periph, uint32_t pin)
{
...
# 383 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_gpio.c"
void gpio_bit_toggle(uint32_t gpio_periph, uint32_t pin)
{
    (*(volatile uint32_t *)(uint32_t)((gpio_periph) + 0x2CU)) = (uint32_t)pin;
}
# 396 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_gpio.c"
void gpio_port_toggle(uint32_t gpio_periph)
{
