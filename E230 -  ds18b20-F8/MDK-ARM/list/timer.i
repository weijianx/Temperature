...
# 110 "../BSP/Src/timer.c"
 ...
 timer_interrupt_enable(((((uint32_t)0x40000000U) + 0x00000000U) + 0x00000400U), ((uint32_t)((uint32_t)0x01U<<(0))));
...
void TIMER15_Init(void)
{
 timer_oc_parameter_struct timer_ocintpara;
    ...
    timer_deinit(((((uint32_t)0x40000000U) + 0x00000000U) + 0x00014400U));
    ...
    timer_initpara.clockdivision = ((uint16_t)(((0xFFFFFFFFUL << (8)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(9)))) & ((uint32_t)(0) << 8U)));
    timer_initpara.repetitioncounter = 0;
    timer_init(((((uint32_t)0x40000000U) + 0x00000000U) + 0x00014400U),&timer_initpara);
# 150 "../BSP/Src/timer.c"
 nvic_irq_enable(TIMER15_IRQn, 3);

    timer_auto_reload_shadow_enable(((((uint32_t)0x40000000U) + 0x00000000U) + 0x00014400U));
...
uint8_t first_20s = 0;
extern uint16_t Current_pulse;

uint16_t pulse_flag0 = 0;
uint16_t pulse_flag1 = 0;


uint16_t status_flag = 0;

uint16_t timeD_flag = 0;

void TIMER0_Channel_IRQHandler(void)
{

 if(timer_interrupt_flag_get(((((uint32_t)0x40000000U) + 0x00000000U) + 0x00012C00U), ((uint32_t)((uint32_t)0x01U<<(1)))))
 {

  timer_interrupt_flag_clear(((((uint32_t)0x40000000U) + 0x00000000U) + 0x00012C00U), ((uint32_t)((uint32_t)0x01U<<(1))));
  ...
  timer_interrupt_enable(((((uint32_t)0x40000000U) + 0x00000000U) + 0x00012C00U), ((uint32_t)((uint32_t)0x01U<<(2))));

 }

 if(timer_interrupt_flag_get(((((uint32_t)0x40000000U) + 0x00000000U) + 0x00012C00U), ((uint32_t)((uint32_t)0x01U<<(2)))))
 {

  timer_interrupt_disable(((((uint32_t)0x40000000U) + 0x00000000U) + 0x00012C00U), ((uint32_t)((uint32_t)0x01U<<(1))));

  timer_interrupt_flag_clear(((((uint32_t)0x40000000U) + 0x00000000U) + 0x00012C00U), ((uint32_t)((uint32_t)0x01U<<(2))));
  ...
  timer_interrupt_enable(((((uint32_t)0x40000000U) + 0x00000000U) + 0x00012C00U), ((uint32_t)((uint32_t)0x01U<<(1))));
 }
...
{
 uint16_t read_pulse = 0;
 uint16_t i;


 if(timer_interrupt_flag_get(((((uint32_t)0x40000000U) + 0x00000000U) + 0x00000400U), ((uint32_t)((uint32_t)0x01U<<(0)))))
 {
  timer_interrupt_flag_clear(((((uint32_t)0x40000000U) + 0x00000000U) + 0x00000400U), ((uint32_t)((uint32_t)0x01U<<(0))));
  Time_1s_flag = 1;
...
void TIMER15_IRQHandler(void)
{
 ...
 if(timer_interrupt_flag_get(((((uint32_t)0x40000000U) + 0x00000000U) + 0x00014400U), ((uint32_t)((uint32_t)0x01U<<(0)))))
 {
  timer_interrupt_flag_clear(((((uint32_t)0x40000000U) + 0x00000000U) + 0x00014400U), ((uint32_t)((uint32_t)0x01U<<(0))));
  AutoUpLoad_counter++;
