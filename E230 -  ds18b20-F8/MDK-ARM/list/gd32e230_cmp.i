# 1 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_cmp.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 359 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_cmp.c" 2
# 37 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_cmp.c"
...
# 38 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_cmp.c" 2
...
# 74 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_cmp.c"
void cmp_mode_init(operating_mode_enum operating_mode, inverting_input_enum inverting_input, cmp_hysteresis_enum output_hysteresis)
{

    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40010000U) + 0x0000001CU)) + 0x00U)) |= (((0xFFFFFFFFUL << (2)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(3)))) & ((uint32_t)(operating_mode) << 2)) | (((0xFFFFFFFFUL << (4)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(6)))) & ((uint32_t)(inverting_input) << 4)) | (((0xFFFFFFFFUL << (12)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(13)))) & ((uint32_t)(output_hysteresis) << 12));

}
# 96 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_cmp.c"
void cmp_output_init(cmp_output_enum output_slection, uint32_t output_polarity)
{


    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40010000U) + 0x0000001CU)) + 0x00U)) |= (((0xFFFFFFFFUL << (8)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(10)))) & ((uint32_t)(output_slection) << 8));

    if(((uint32_t)0x00000001) == output_polarity){
         (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40010000U) + 0x0000001CU)) + 0x00U)) |= ((uint32_t)((uint32_t)0x01U<<(11)));
    }else{
         (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40010000U) + 0x0000001CU)) + 0x00U)) &= ~((uint32_t)((uint32_t)0x01U<<(11)));
    }
