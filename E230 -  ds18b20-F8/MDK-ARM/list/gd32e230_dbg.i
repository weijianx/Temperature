# 1 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_dbg.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 359 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_dbg.c" 2
# 37 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_dbg.c"
...
# 38 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_dbg.c" 2
# 47 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_dbg.c"
void dbg_deinit(void)
{
...
# 74 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_dbg.c"
void dbg_low_power_enable(uint32_t dbg_low_power)
{
    (*(volatile uint32_t *)(uint32_t)(((uint32_t)0x40015800U) + 0x04U)) |= dbg_low_power;
}
# 89 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_dbg.c"
void dbg_low_power_disable(uint32_t dbg_low_power)
{
    (*(volatile uint32_t *)(uint32_t)(((uint32_t)0x40015800U) + 0x04U)) &= ~dbg_low_power;
}
# 113 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_dbg.c"
void dbg_periph_enable(dbg_periph_enum dbg_periph)
{
    ((*(volatile uint32_t *)(uint32_t)(((uint32_t)0x40015800U) + ((uint32_t)(dbg_periph) >> 6)))) |= ((uint32_t)((uint32_t)0x01U<<(((uint32_t)(dbg_periph) & 0x1FU))));
}
# 137 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_dbg.c"
void dbg_periph_disable(dbg_periph_enum dbg_periph)
{
    ((*(volatile uint32_t *)(uint32_t)(((uint32_t)0x40015800U) + ((uint32_t)(dbg_periph) >> 6)))) &= ~((uint32_t)((uint32_t)0x01U<<(((uint32_t)(dbg_periph) & 0x1FU))));
}
