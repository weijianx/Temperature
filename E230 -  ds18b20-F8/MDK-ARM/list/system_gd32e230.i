# 1 "../GD32E230_Firmware_Library/CMSIS/GD/GD32E230/Source/system_gd32e230.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 359 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../GD32E230_Firmware_Library/CMSIS/GD/GD32E230/Source/system_gd32e230.c" 2
# 36 "../GD32E230_Firmware_Library/CMSIS/GD/GD32E230/Source/system_gd32e230.c"
...
# 37 "../GD32E230_Firmware_Library/CMSIS/GD/GD32E230/Source/system_gd32e230.c" 2
# 65 "../GD32E230_Firmware_Library/CMSIS/GD/GD32E230/Source/system_gd32e230.c"
...
# 240 "../GD32E230_Firmware_Library/CMSIS/GD/GD32E230/Source/system_gd32e230.c"
static void system_clock_72m_irc8m(void)
{
    uint32_t timeout = 0U;
    ...
    do{
        timeout++;
        stab_flag = ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00001000U) + 0x00U)) & ((uint32_t)((uint32_t)0x01U<<(1))));
    }
    while((0U == stab_flag) && (((uint16_t)0x0500) != timeout));


    if(0U == ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00001000U) + 0x00U)) & ((uint32_t)((uint32_t)0x01U<<(1))))){
        while(1){
        }
    }

    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00002000U)) + 0x00U)) &= ~((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(2))));
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00002000U)) + 0x00U)) |= ((uint8_t)0x02U);


    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00001000U) + 0x04U)) |= (((0xFFFFFFFFUL << (4)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(7)))) & ((uint32_t)(0) << 4));

    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00001000U) + 0x04U)) |= (((0xFFFFFFFFUL << (11)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(13)))) & ((uint32_t)(0) << 11));

    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00001000U) + 0x04U)) |= (((0xFFFFFFFFUL << (8)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(10)))) & ((uint32_t)(0) << 8));
    ...
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00001000U) + 0x04U)) |= ((uint32_t)0x00000000U | (((uint32_t)((uint32_t)0x01U<<(27))) | (((0xFFFFFFFFUL << (18)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(21)))) & ((uint32_t)(1) << 18))));


    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00001000U) + 0x00U)) |= ((uint32_t)((uint32_t)0x01U<<(24)));


    while(0U == ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00001000U) + 0x00U)) & ((uint32_t)((uint32_t)0x01U<<(25))))){
    }


    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00001000U) + 0x04U)) &= ~((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1))));
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00001000U) + 0x04U)) |= (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(2) << 0));


    while(0U == ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00001000U) + 0x04U)) & (((0xFFFFFFFFUL << (2)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(3)))) & ((uint32_t)(2) << 2)))){
    }
}
# 322 "../GD32E230_Firmware_Library/CMSIS/GD/GD32E230/Source/system_gd32e230.c"
