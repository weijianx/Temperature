...
# 30 "../APP/Src/ds18b20.c"
void delay_750us(void)
{
 uint32_t tim=4000;
 while(tim--);
}
# 47 "../APP/Src/ds18b20.c"
void delay_15us(void)
{
 uint32_t tim=78;
 while(tim--);
}
# 64 "../APP/Src/ds18b20.c"
void delay_12us(void)
{
 uint32_t tim=62;
 while(tim--);
}
# 82 "../APP/Src/ds18b20.c"
void delay_50us(void)
{
 uint32_t tim=277;
 while(tim--);
}
# 99 "../APP/Src/ds18b20.c"
void delay_60us(void)
{
 uint32_t tim=330;
 while(tim--);
...
void DS18B20_Output(void)
{
 rcu_periph_clock_enable(RCU_GPIOA);
    ...
    gpio_mode_set(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000000U), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(1) << 0)), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(2) << 0)), ((uint32_t)((uint32_t)0x01U<<(9))));

 gpio_output_options_set(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000000U), ((uint8_t)(0x00U)), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(3) << 0)), ((uint32_t)((uint32_t)0x01U<<(9))));
...
void DS18B20_Input(void)
{
 rcu_periph_clock_enable(RCU_GPIOA);
    ...
    gpio_mode_set(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000000U), (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(0) << 0)) , (((0xFFFFFFFFUL << (0)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(1)))) & ((uint32_t)(2) << 0)), ((uint32_t)((uint32_t)0x01U<<(9))));
...
{
 DS18B20_Output();
 gpio_bit_write(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000000U), ((uint32_t)((uint32_t)0x01U<<(9))), RESET);

 delay_750us();

 gpio_bit_write(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000000U), ((uint32_t)((uint32_t)0x01U<<(9))), SET);
 delay_15us();
...
uint8_t DS18B20_Check(void)
{
 uint8_t retry=0;
 DS18B20_Input();
    while (gpio_input_bit_get(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000000U), ((uint32_t)((uint32_t)0x01U<<(9))))&&retry<200)
 {
  retry++;
  delay_us(5);
 ...
 if(retry>=200)return 1;
    ...
    while (!gpio_input_bit_get(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000000U), ((uint32_t)((uint32_t)0x01U<<(9))))&&retry<240)
 {
  retry++;
  delay_us(5);
...
uint8_t DS18B20_Read_Bit(void)
{
 ...
 if(gpio_input_bit_get(((((uint32_t)0x48000000U) + 0x00000000U) + 0x00000000U), ((uint32_t)((uint32_t)0x01U<<(9)))))data=1;
 else data=0;
...
int DS18B20_Get_Temp(void)
{
 ...
 int temperature;
    ...
    tem<<=8;
    tem+=TL;
    temperature=(int)tem*6250;
 if(temp)return temperature;
 else return -temperature;
# 321 "../APP/Src/ds18b20.c"
}
