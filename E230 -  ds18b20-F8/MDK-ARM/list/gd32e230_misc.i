# 1 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_misc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 359 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_misc.c" 2
# 37 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_misc.c"
...
# 38 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_misc.c" 2
...
# 73 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_misc.c"
void nvic_system_reset(void)
{
    __NVIC_SystemReset();
}
# 87 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_misc.c"
void nvic_vector_table_set(uint32_t nvic_vict_tab, uint32_t offset)
{
    ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->VTOR = nvic_vict_tab | (offset & ((uint32_t)0x1FFFFF80));
}
# 103 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_misc.c"
void system_lowpower_set(uint8_t lowpower_mode)
{
    ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->SCR |= (uint32_t)lowpower_mode;
}
# 119 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_misc.c"
void system_lowpower_reset(uint8_t lowpower_mode)
{
    ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->SCR &= (~(uint32_t)lowpower_mode);
}
# 133 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_misc.c"
void systick_clksource_set(uint32_t systick_clksource)
{
