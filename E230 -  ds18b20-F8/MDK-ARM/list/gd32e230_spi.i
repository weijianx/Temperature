# 1 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_spi.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 359 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_spi.c" 2
# 37 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_spi.c"
...
# 38 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_spi.c" 2
# 59 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_spi.c"
void spi_i2s_deinit(uint32_t spi_periph)
{
    switch(spi_periph){
...
# 117 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_spi.c"
ErrStatus spi_init(uint32_t spi_periph, spi_parameter_struct* spi_struct)
{
    uint32_t reg1, reg2, reg3 = 0U;

    reg1 = (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00U));
    reg1 &= ((uint32_t)0x00003040U);

    reg2 = (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00U));
    reg2 &= ((uint32_t)0x00003840U);

    reg3 = (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x04U));
    ...
    if( ((((uint32_t)0x40000000U) + 0x00003800U) + 0x0000F800U) == spi_periph){
        ...
        (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00U)) = (uint32_t)reg1;
        ...
        (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00U)) = (uint32_t)reg2;


        reg3 |= spi_struct->frame_size;

        (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x04U)) = (uint32_t)reg3;
    }


    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x1CU)) &= (uint32_t)(~((uint32_t)((uint32_t)0x01U<<(11))));
...
void spi_enable(uint32_t spi_periph)
{
    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00U)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(6)));
}
...
# 228 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_spi.c"
void i2s_init(uint32_t spi_periph, uint32_t mode, uint32_t standard, uint32_t ckpl)
{
    uint32_t reg = 0U;
    reg = (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x1CU));
    ...
    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x1CU)) = (uint32_t)reg;
}
# 274 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_spi.c"
void i2s_psc_config(uint32_t spi_periph, uint32_t audiosample, uint32_t frameformat, uint32_t mckout)
{
    ...
    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x20U)) = ((uint32_t)0x00000002U);
    ...
    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x20U)) = (uint32_t)(i2sdiv | i2sof | mckout);


    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x1CU)) &= (uint32_t)(~(((0xFFFFFFFFUL << (1)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(2)))) | ((uint32_t)((uint32_t)0x01U<<(0)))));

    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x1CU)) |= (uint32_t)frameformat;
}
# 325 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_spi.c"
void i2s_enable(uint32_t spi_periph)
{
    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x1CU)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(10)));
}
...
void spi_nss_output_enable(uint32_t spi_periph)
{
    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x04U)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(2)));
}
...
void spi_nss_internal_high(uint32_t spi_periph)
{
    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00U)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(8)));
}
...
# 395 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_spi.c"
void spi_dma_enable(uint32_t spi_periph, uint8_t dma)
{
    if(((uint8_t)0x00U) == dma){
        (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x04U)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(1)));
    }else{
        (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x04U)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(0)));
    }
}
# 414 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_spi.c"
void spi_dma_disable(uint32_t spi_periph, uint8_t dma)
{
    if(((uint8_t)0x00U) == dma){
        (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x04U)) &= (uint32_t)(~((uint32_t)((uint32_t)0x01U<<(1))));
...
# 444 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_spi.c"
ErrStatus spi_i2s_data_frame_format_config(uint32_t spi_periph, uint16_t frame_format)
{
    if(((((uint32_t)0x40000000U) + 0x00003800U) + 0x0000F800U) == spi_periph)
    {
        ...
        if(((((0xFFFFFFFFUL << (8)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(11)))) & ((uint32_t)(7) << 8)) != frame_format) && ((((0xFFFFFFFFUL << (8)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(11)))) & ((uint32_t)(15) << 8)) != frame_format))
        {
            ...
            (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00U)) &= (uint32_t)(~((uint32_t)((uint32_t)0x01U<<(11))));

            (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00U)) |= ((uint32_t)frame_format & ((uint32_t)0x00000800U));
        }
    }
    else{

        (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x04U)) &= (uint32_t)(~((0xFFFFFFFFUL << (8)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(11)))));

        (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x04U)) |= (uint32_t)frame_format;
    }
    return SUCCESS;
}
# 475 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_spi.c"
void spi_i2s_data_transmit(uint32_t spi_periph, uint16_t data)
{
    uint32_t reg, byten;
    if(((((uint32_t)0x40000000U) + 0x00003800U) + 0x0000F800U) == spi_periph)
    {
        (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x0CU)) = (uint32_t)data;
    }
    else
    {

        byten = (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x04U)) & ((uint32_t)0x00001000U);
        if(RESET != byten)
        {
        ...
        {
            (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x0CU)) = (uint16_t)data;
        }
    }
}
...
uint16_t spi_i2s_data_receive(uint32_t spi_periph)
{
    ...
    if(((((uint32_t)0x40000000U) + 0x00003800U) + 0x0000F800U) == spi_periph)
    {
        return ((uint16_t)(*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x0CU)));
    }
    else
    {
...
# 535 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_spi.c"
void spi_bidirectional_transfer_config(uint32_t spi_periph, uint32_t transfer_direction)
{
    if(((uint32_t)((uint32_t)0x01U<<(14))) == transfer_direction){

        (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00U)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(14)));
    }else{

        (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00U)) &= (~((uint32_t)((uint32_t)0x01U<<(14))));
    }
}
# 553 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_spi.c"
void spi_crc_polynomial_set(uint32_t spi_periph, uint16_t crc_poly)
{

    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00U)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(13)));

    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x10U)) = (uint32_t)crc_poly;
}
...
uint16_t spi_crc_polynomial_get(uint32_t spi_periph)
{
    return ((uint16_t)(*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x10U)));
}
...
void spi_crc_next(uint32_t spi_periph)
{
    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00U)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(12)));
}
# 615 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_spi.c"
uint16_t spi_crc_get(uint32_t spi_periph, uint8_t crc)
{
    if(((uint8_t)0x00U) == crc){
        return ((uint16_t)((*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x18U))));
    }else{
        return ((uint16_t)((*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x14U))));
    }
}
...
void spi_ti_mode_enable(uint32_t spi_periph)
{
    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x04U)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(4)));
}
...
void spi_nssp_mode_enable(uint32_t spi_periph)
{
    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x04U)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(3)));
}
...
void qspi_enable(uint32_t spi_periph)
{
    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x80U)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(0)));
}
...
void qspi_write_enable(uint32_t spi_periph)
{
    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x80U)) &= (uint32_t)(~((uint32_t)((uint32_t)0x01U<<(1))));
}
...
void qspi_io23_output_enable(uint32_t spi_periph)
{
    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x80U)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(2)));
}
...
# 746 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_spi.c"
void spi_i2s_interrupt_enable(uint32_t spi_periph, uint8_t interrupt)
{
    switch(interrupt){

    case ((uint8_t)0x00U):
        (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x04U)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(7)));
        break;

    case ((uint8_t)0x01U):
        (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x04U)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(6)));
        break;

    case ((uint8_t)0x02U):
        (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x04U)) |= (uint32_t)((uint32_t)((uint32_t)0x01U<<(5)));
        break;
    default:
        break;
    }
}
# 778 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_spi.c"
void spi_i2s_interrupt_disable(uint32_t spi_periph, uint8_t interrupt)
{
    switch(interrupt){
...
# 813 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_spi.c"
FlagStatus spi_i2s_interrupt_flag_get(uint32_t spi_periph, uint8_t interrupt)
{
    uint32_t reg1 = (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x08U));
    uint32_t reg2 = (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x04U));
...
# 895 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_spi.c"
FlagStatus spi_i2s_flag_get(uint32_t spi_periph, uint32_t flag)
{
    if(RESET != ((*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x08U)) & flag)){
        return SET;
    }else{
        if((((uint32_t)0x40000000U) + 0x00003800U) == spi_periph){

            if((((0xFFFFFFFFUL << (9)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(10)))) & ((uint32_t)(0) << 9)) == flag){
                if(RESET != ((*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x08U)) & ((uint32_t)0x00001800U))){
                    return RESET;
                }else{
                    return SET;
                }
            ...
            if((((0xFFFFFFFFUL << (9)) & (0xFFFFFFFFUL >> (31U - (uint32_t)(10)))) & ((uint32_t)(0) << 9)) == flag){
                if(RESET != ((*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x08U)) & ((uint32_t)0x00000600U))){
                    return RESET;
                }else{
                    return SET;
                }
...
void spi_crc_error_clear(uint32_t spi_periph)
{
    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x08U)) &= (uint32_t)(~((uint32_t)((uint32_t)0x01U<<(4))));
}
# 943 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_spi.c"
void spi_fifo_access_size_config(uint32_t spi_periph, uint16_t fifo_access_size)
{

    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x04U)) &= (uint32_t)(~((uint32_t)((uint32_t)0x01U<<(12))));

    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x04U)) |= (uint32_t)fifo_access_size;
}
# 961 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_spi.c"
void spi_transmit_odd_config(uint32_t spi_periph, uint16_t odd)
{

    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x04U)) &= (uint32_t)(~((uint32_t)((uint32_t)0x01U<<(14))));

    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x04U)) |= (uint32_t)odd;
}
# 979 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_spi.c"
void spi_receive_odd_config(uint32_t spi_periph, uint16_t odd)
{

    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x04U)) &= (uint32_t)(~((uint32_t)((uint32_t)0x01U<<(13))));

    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x04U)) |= (uint32_t)odd;
}
# 997 "../GD32E230_Firmware_Library/GD32E230_standard_peripheral/Source/gd32e230_spi.c"
void spi_crc_length_set(uint32_t spi_periph, uint16_t crc_length)
{

    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00U)) &= (uint32_t)(~((uint32_t)((uint32_t)0x01U<<(11))));

    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00U)) |= (uint32_t)crc_length;
}
